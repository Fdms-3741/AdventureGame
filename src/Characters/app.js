...
const mongo = require('mongoose') /* API for integration with MongoDB database */
...
const MongoDBAddress  = "http://" + process.env.MONGODB_USER + ":" + process.env.MONGODB_PASSWORD +"@characterdb/" /* Gets username and password from environment variables set in the container */
